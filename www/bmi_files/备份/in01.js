...
setTimeout(function(){
	...
	$('#btn').click(function(){
		var height =$("div[data-page='profile1']").find(".row").eq(1).find(".number").attr("value")/100;
		var weight =$("div[data-page='profile1']").find(".row").eq(2).find(".number").attr("value");
		var age = $("div[data-page='profile1']").find(".row").eq(0).find(".number").attr("value");
		...
		var content = "<ul><li>Your BMI value is "+bmi.toFixed(2)+",Your body is "+rst+"</li></ul>";
		if(bmi < 19){
			var content = "<ul><li>Your BMI value is "+bmi.toFixed(2)+",Your body is "+rst+"</li><li><a href='2.html'>Page2</li></ul>";
		}else if( bmi > 23){
			var content = "<ul><li>Your BMI value is "+bmi.toFixed(2)+",Your body is "+rst+"</li><li><a href='3.html'>Page3</li></ul>";
		}
